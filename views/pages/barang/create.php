          ...
          <form method="POST" action="index.php?action=save_barang">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <input type="text" name="kode_barang" class="form-control"  required value="BRG- -">
              </div>
              <div class="col-md-6">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="jumlah" class="form-control" id="no_hp" placeholder="jumlah barang">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="lokasi" class="form-control" id="jam" value="Gudang">
              </div>
            </div>
