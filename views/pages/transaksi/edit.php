          ...
          <form method="POST" action="index.php?action=update_barang">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="jumlah" class="form-control" id="no_hp" value="<?= $transaksi['jumlah'] ?>">
              </div>
            </div>

            <div class="row mb-3">
              <div class="col-md-6">
                <label for="hari" class="form-label">Status</label>
                <i><?= $transaksi['status'] ?> , transaksi sebelum edit</i>
              ...
              <div class="col-md-6">
                <label for="jam" class="form-label">keterangan</label>
                <textarea type="text" name="keterangan" class="form-control" id="jam"><?=$transaksi['keterangan']; ?></textarea>
              </div>
            </div>
